        ...
        _render: function () {
            ...
            var waiting = setInterval(function() {
                ...
                if (
                    ...
                    console.log(scope.state.data.selectedLocations.length);
                    console.log(scope.state.data.allLocations.length);
                    console.log(scope.state.data.warehouses);
                    console.log(scope.state.data.legendItems);
                    ...
                    if (! scope.renderer) {
                        ...
                        if (scope.currentWarehouse) {
                            console.log(scope.currentWarehouse);
