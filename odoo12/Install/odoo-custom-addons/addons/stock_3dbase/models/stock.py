...
class StockLocation(models.Model):
    ...
    posx = fields.Float('Pos (X)', copy=False, default=0)
    posy = fields.Integer('Pos (Y)', copy=False, default=0)
    posz = fields.Integer('Pos (Z)', copy=False, default=0)
    sizex = fields.Integer('Size (X)', copy=False, default=0)
    sizey = fields.Integer('Size (Y)', copy=False, default=0)
    sizez = fields.Integer('Size (Z)', copy=False, default=0)
    ...
    warehouse_id = fields.Many2one('stock.warehouse', string='Warehouse',
        compute='_get_warehouse', store=True, help="Location warehouse")
